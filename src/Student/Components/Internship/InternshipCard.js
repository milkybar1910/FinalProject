...
import { removeInternship } from "../../helper/StudentApiCall";

const InternshipCard = ({ internship, onReload }) => {
      ...
      <Container fluid>
        <Row>
          ...
          >
            <Image
              thumbnail={true}
              src={`${API}/internship/certificate/${internship._id}`}
              alt="loading..."
              width={150}
              height={150}
            />
          ...
          <Col xs={11} md={10} className=" border-bottom align-self-center">
            <Row>
              ...
              >
                ...
                <p className="m-0 ">
                  {internship["Organization Name"]} , {internship["Location"]}
                </p>
                <p className="m-0 text-black-50 mb-2">
                  {internship["From"]} - {internship["To"]}
                </p>
              </Col>
              <InternshipView
                show={show}
